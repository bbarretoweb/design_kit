...
void main() {
  group('DkBrandTheme implementations', () {
    ...
    testWidgets(
      'BetaCorpBrandTheme().light() contains DkRadii with md == '
      'BorderRadius.circular(16)',
      (tester) async {
        final theme = const BetaCorpBrandTheme().light();
        final radii = theme.extension<DkRadii>();
    ...
    testWidgets(
      'BetaCorpBrandTheme().light() contains DkSpacing with md == 20.0',
      (tester) async {
        final theme = const BetaCorpBrandTheme().light();
    ...
    testWidgets('Both brands return ThemeData with useMaterial3 == true', (
      ...
      final beta = const BetaCorpBrandTheme().light();
      expect(acme.useMaterial3, isTrue);
      expect(beta.useMaterial3, isTrue);
    });

    testWidgets(
      'Swap AcmeBrandTheme for BetaCorpBrandTheme -> DkButton renders '
      'without error',
      (tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            theme: const BetaCorpBrandTheme().light(),
            home: Scaffold(
              body: DkButton.filled(
